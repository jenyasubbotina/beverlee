...
public class PinChangeCounterTask extends AsyncTask<Void, Integer, Integer> {
    ...
    public PinChangeCounterTask(@NonNull final Resources res,
    ...
    protected void onPostExecute(Integer integer) {
        ...
        firstBtnRef.get().setEnabled(true);
        firstBtnRef.get().setBackground(ResourcesCompat.getDrawable(resourcesRef.get(), R.drawable.btn_orange, null));
        secondBtnRef.get().setEnabled(true);
        secondBtnRef.get().setBackground(ResourcesCompat.getDrawable(resourcesRef.get(), R.drawable.btn_grey, null));
    ...
    private static final String TAG = PinChangeCounterTask.class.toString();
}